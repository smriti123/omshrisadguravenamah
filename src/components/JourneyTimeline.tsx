    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderLeft: `${event.mahasamadhi ? 6 : special ? 5 : 4}px solid ${
            event.mahasamadhi
              ? "#ea580c"
              : special
              ? "#d97706"
      ...
      >
        ...
        <h3
          ...
          style={{ color: event.highlight || special ? "#3d2817" : "#684229" }}
        >
          {event.title}
        </h3>
        <p
