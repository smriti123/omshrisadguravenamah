...
import v8_1 from "@/assets/gallery/v8.1.jpeg";
...
const visheshPhotos: Photo[] = [
  {
    ...
    vintage: true,
    story: "This rare photograph shows Swamiji seated beside one of the most revered saints of the Narmada region. The two met only once, but their conversation lasted through the night. Swamiji later recalled — 'He spoke no philosophy, asked no questions. He simply sat in silence, and that silence answered everything I had been seeking for years.'",
  },
  { src: v2, label: "Sacred gathering",  vintage: true },
  {
    ...
    vintage: true,
    story: "Taken at the Kumbh Mela, where Swamiji walked barefoot along the Ganga for three days, blessing thousands of pilgrims. Despite the enormous crowds, devotees recalled that Swamiji moved with absolute stillness — as if in deep meditation even while walking. Many reported feeling an inexplicable peace simply by being near him.",
  },
