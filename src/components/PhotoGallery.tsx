...
const visheshPhotos: Photo[] = [
  ...
  { src: v6, label: "", vintage: true },
  {
    ...
    vintage: true,
    story:
      "All final rites of Pujya Gurudev as I had reiterated in past ..were fone by Pujya Brahmaleen His Holiness  Swami Subodanandji immaculately with precision amidst all top Saints present there... You name it..you think it'",
  },
  {
    src: v9,
    label: "Gurudev Mahasamadhi",
...
const Lightbox = ({
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          "radial-gradient(circle at top, rgba(80,35,10,0.94) 0%, rgba(35,16,6,0.96) 45%, rgba(24,10,4,0.98) 100%)",
      }}
      onClick={onClose}
    >
      <div
      ...
      >
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(180deg, rgba(50,22,8,0.96) 0%, rgba(50,22,8,0.86) 70%, rgba(50,22,8,0) 100%)",
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
              <img
                ...
                style={
                  photo.vintage
                    ? { filter: "sepia(60%) contrast(1.05) brightness(0.94)" }
                    : {}
                }
              />
            </motion.div>
          ...
          <div className="mt-3 text-center">
            <p
              ...
              style={{ color: "rgba(255,220,150,0.85)" }}
            >
              {photo.label}
              {photo.vintage && (
                <span
  ...
  return (
    ...
    >
      <div
        className={
          hasStory
            ? "grid grid-cols-1 md:grid-cols-[minmax(220px,34%)_1fr]"
            : "relative"
        }
      >
        ...
        {hasStory && (
          <div
            className={`p-4 md:p-5 flex flex-col ${isFirstPhoto ? "items-center justify-center text-center" : ""}`}
          >
            {photo.label && (
              <p
                className={
                  isFirstPhoto
                    ? "text-2xl md:text-4xl font-bold tracking-wide"
            ...
            {!isFirstPhoto && (
              <>
                ...
                <p
                  className="text-[11px] tracking-[0.14em] uppercase mt-4"
                  style={{ color: "rgba(130,70,20,0.55)" }}
                >
...
const SectionHeading = ({
  ...
  <div className="text-center mb-8">
    <p
      ...
      style={{ color: "rgba(160,90,16,0.6)" }}
    >
      {sub}
    </p>
    <h3
    ...
    <p
      ...
      style={{ color: "rgba(140,70,10,0.65)", fontFamily: "serif" }}
    >
      {hindi}
    </p>
    {description && (
      <p
        className="text-sm md:text-base max-w-3xl mx-auto mb-4"
        style={{ color: "rgba(120,65,14,0.75)", fontFamily: "serif" }}
      >
        {description}
      </p>
    )}
    <div className="flex items-center justify-center gap-3">
      <div
        className="w-12 h-px"
        style={{ background: "rgba(180,100,20,0.35)" }}
      />
    ...
    <div>
      ...
      {remaining > 0 && (
        <div className="flex flex-col items-center mt-8 gap-2">
          <p
            ...
            style={{ color: "rgba(160,90,16,0.5)" }}
          >
            Showing {visible} of {photos.length} photos
          </p>
          <button
            onClick={() =>
              setVisible((v) => Math.min(v + PER_LOAD, photos.length))
            }
      ...
      {remaining <= 0 && photos.length > INITIAL && (
        <p
          ...
          style={{ color: "rgba(160,90,16,0.35)" }}
        >
...
const GallerySection = () => {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, hsl(34 50% 78%) 0%, hsl(32 55% 68%) 40%, hsl(34 50% 75%) 100%)",
      }}
    >
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p
          className="text-center text-xs mt-12 tracking-wider"
          style={{ color: "rgba(160,90,16,0.4)" }}
        >
          Every card shows photo + story snippet · Click any card to read full
          story
        </p>
      </div>
