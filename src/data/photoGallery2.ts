...
export const gallery2Categories: Gallery2Category[] = [
  {
    ...
    photos: [
      ...
      },
      {
        ...
        caption: "प्रणतदेहिनां पापकर्शनंः",
      },
      {
        id: "charan-vandan-6",
        ...
        caption: "ऐसे गुरु को बलि-बलि जाऊँ",
      },
      {
        id: "charan-vandan-7",
        src: newCharanSofa,
        thumbnailSrc: newCharanSofa,
        alt: "श्री गुर पद नख मनि गन जोती। सुमिरत दिब्य दृष्टि हियँ होती",
        caption: "",
      },
      {
        id: "charan-vandan-8",
        ...
        alt: "गुरु पद रज मृदु मंजुल अंजन। नयन अमिअ दृग दोष बिभंजन",
        caption: "",
      },
    ],
  },
